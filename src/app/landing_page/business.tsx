...
const Business = (props: any) => {
  return (
    <main className="flex flex-col min-h-screen items-center justify-between pt-6">
      ...
      <div className="p-0">
        <div className="grid grid-cols-1 md:grid-cols-[25%_50%_25%] md:col-span-3 justify-center items-center gap-4 px-20 border-2 border-black">

          {/*START GRID VIEW BUSINESS 1 */}
          <div className="relative w-full h-full row-span-1 md:row-span-2 border-2 border-black my-0 py-0">
          ...
          <div className="relative border-2 border-black">
            <div className="bg-sky-600 text-white p-0 relative">
              <div className="p-0 mt-auto">
                <Image
                  src={tes}
          ...
          <div className="relative w-full h-full row-span-1 md:row-span-2 border-2 border-black">
          ...
          <div className="col-span-1 md:col-span-3 bg-green-600 text-white border-2 border-black">
            <div className="w-full grid grid-cols-1 md:grid-cols-2   border-2 border-red" >
